import {
  LayoutDashboard, Users, Package, Calendar, Building2, FolderOpen, Settings, LogOut, Zap
} from 'lucide-react';
...
const items = [
  ...
  { title: 'Pedidos', url: '/pedidos', icon: Package, badge: '3' },
  { title: 'Agenda', url: '/agenda', icon: Calendar, badge: '2' },
    ...
    <Sidebar collapsible="icon" className="border-r border-sidebar-border glass">
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="flex flex-col">
              <span className="text-sm font-bold text-sidebar-foreground letter-tight">Hub Comercial</span>
      ...
      <SidebarFooter className="p-3 relative z-10 border-t border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <Button variant="ghost" size="icon" onClick={logout} className="h-8 w-8 text-sidebar-foreground/40 hover:text-destructive shrink-0">
